  ...
  const defaultProjects = [
    {
      ...
      desc: "Built an interactive Power BI dashboard consolidating real-time sales and operational data for elderly care services, surfacing total revenue and monthly growth to guide decisions.",
      impact: "Impact: Primary reporting reference for VTAB Square stakeholders.",
    ...
    },
    {
      ...
      desc: "Built an interactive Power BI dashboard analyzing loan disbursement, banking performance, and customer insights with dynamic filters that improved business decision-making.",
      impact: "Impact: Streamlined loan performance tracking & customer analysis.",
    ...
    },
    {
      ...
      desc: "Engineered a real-time DDoS anomaly detection system using LSTM models with Python, TensorFlow, Ryu Controller, and Mininet, achieving 98.2% detection accuracy.",
      impact: "Impact: Achieved 98.2% detection accuracy in real-time SDN environments.",
      tech: ["Python", "TensorFlow", "LSTM", "SDN"],
    ...
    },
    {
      ...
      desc: "Applied exploratory data analysis (EDA) and supervised machine learning models (Linear Regression, KNN) to uncover regional rainfall patterns and construct predictive weather models.",
